...
import com.codigotutorial.book.common.PageResponse;
import com.codigotutorial.book.exception.OperationNotPermittedException;
import com.codigotutorial.book.file.FileStorageService;
import com.codigotutorial.book.history.BookTransactionHistory;
import com.codigotutorial.book.history.BookTransactionHistoryRepository;
...
public class BookService {
    ...
    public Integer returnBorrowedBook(Integer bookId, Authentication connectedUser) {
        ...
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException("The requested book cannot be borrowed since it " +
                    "is archived or not shareable");
        }
    ...
    public void uploadBookCoverPicture(MultipartFile file, Authentication connectedUser, Integer bookId) {
        ...
        book.setBookCover(bookCover); // filepath
